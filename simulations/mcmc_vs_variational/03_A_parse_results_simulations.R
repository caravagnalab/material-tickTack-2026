...
saveRDS(results_all, paste0(base_dir,"results_summary/results_all_simulations.rds"))
...
###################### if inference results is not available only take the variational one if it exissts #######################
library(dplyr)
library(purrr)
library(tibble)
library(mclust)
