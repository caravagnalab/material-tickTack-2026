...
saveRDS(sample_list, "/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/sample_list.RDS")
multi_results <- run_multi_sample_summary(sample_list, karyotypes)
saveRDS(multi_results, "/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/multi_results.RDS")

sample_list <- readRDS("/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/sample_list.RDS")
multi_results <- readRDS("/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/multi_results.RDS")
...
pdf("/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/Timed_cohort_karyotype_all_cancer_types.pdf", width = 16, height = 12)
...
pdf(paste0("/orfeo/cephfs/scratch/cdslab/scocomello/material-tickTack-2026/PCAWG/Analysis_results/Cohort_stat/complex_segments/", "karyotype_by_cancer_type.pdf"), width = 16, height = 12)
