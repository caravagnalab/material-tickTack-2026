...
results_all_K <- readRDS(paste0(base_dir, "results_summary/results_comptime_simulations_per_K.rds"))
...
p1 <- ggplot(mean_time_K, aes(x = factor(K), y = mean_time, fill = inference)) +
...
ggplot2::ggsave(paste0(base_dir,"/plot/results_comptime_mcmcvsvar.png"),plot = p_final, width = 10, height = 20)
